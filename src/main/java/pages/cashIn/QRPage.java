...
// import components.RoundedButton; // REMOVE: Use standard JButton from Factory
import javax.swing.*;
// 🔑 ADD FACTORY IMPORTS
...
public class QRPage extends JPanel {
    ...
    private void setupUI() {
        ...
        // ⭐ FACTORY USAGE: Header Panel with Back Button
        JPanel headerPanel = factory.createHeaderPanel(onButtonClick, "CashInPage");
        ...
        int max_width = factory.getMaxComponentWidth();
        int field_height = factory.getFieldHeight();
        confirmButton.setPreferredSize(new Dimension(max_width, field_height));
        confirmButton.setMaximumSize(new Dimension(max_width, field_height));
        confirmButton.setMinimumSize(new Dimension(max_width, field_height));
