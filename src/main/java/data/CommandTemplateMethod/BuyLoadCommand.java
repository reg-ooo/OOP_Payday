...
public class BuyLoadCommand extends TransactionCommand{
    ...
    public BuyLoadCommand(double amount) {
        this.amount = amount;
    }
    ...
    protected void logTransaction() {
        transactionDAO.insertTransaction(UserInfo.getInstance().getCurrentUserId(), "Buy Load", amount);
    }
}
