...
public class PayBillsCommand extends TransactionCommand{
    ...
    public PayBillsCommand(double amount){
        this.amount = amount;
    }
    ...
    protected void logTransaction() {
        transactionDAO.insertTransaction(UserInfo.getInstance().getCurrentUserId(), "Pay Bills", amount);
    }
}
